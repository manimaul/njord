...
/**
 * https://s57dev.mxmariner.com/control/symbols/RESARE/CATREA
 * List
 *
 */
enum class Catrea {
    ...
    companion object {
        fun fromId(id: Int): Catrea? = when (id) {
...
fun S57Prop.catrea() : List<Catrea> {
    return intValues("CATREA").mapNotNull { Catrea.fromId(it) }
}
