...
fun haversineDistance(origin: GeoPoint, destination: GeoPoint) : Double {
    val radius = 6371.0
...
fun cartesianDistance(origin: GeoPoint, destination: GeoPoint) : Double {
...
fun latitudeDistortion(latitude: Double) : Double {
...
fun getZoomForTrueScale(trueScale: Double) : Int {
    var t = 30
    val tp = 0.70
    var ts = trueScale * tp
    while (ts > 1.0) {
