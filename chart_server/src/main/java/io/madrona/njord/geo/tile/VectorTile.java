...
public final class VectorTile {
  ...
  public interface TileOrBuilder extends
     ...
     * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
     */
    Tile.Layer getLayers(int index);
    /**
     * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
     */
    int getLayersCount();
     ...
     * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
     */
    Tile.LayerOrBuilder getLayersOrBuilder(
        int index);
  }
  /**
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                layers_ = new java.util.ArrayList<Layer>();
                mutable_bitField0_ |= 0x00000001;
              }
              layers_.add(
                  input.readMessage(Layer.PARSER, extensionRegistry));
              break;
            }
            default: {
  ...
  bitField0_ |= 0x00000001;
    ...
    private static final long serialVersionUID = 0L;
            ...
            switch (tag) {
              ...
              case 16: {
                if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                  tags_ = new java.util.ArrayList<Integer>();
              ...
              case 32: {
                if (!((mutable_bitField0_ & 0x00000008) == 0x00000008)) {
                  geometry_ = new java.util.ArrayList<Integer>();
      ...
      private java.util.List<Integer> geometry_;
      /**
       * <pre>
       * Contains a stream of commands and parameters (vertices).
       * A detailed description on geometry encoding is located in 
      ...
      public static final class Builder extends
        ...
        private java.util.List<Integer> tags_ = java.util.Collections.emptyList();
        private void ensureTagsIsMutable() {
          if (!((bitField0_ & 0x00000002) == 0x00000002)) {
            tags_ = new java.util.ArrayList<Integer>(tags_);
            bitField0_ |= 0x00000002;
           }
        }
        /**
        ...
        private java.util.List<Integer> geometry_ = java.util.Collections.emptyList();
        private void ensureGeometryIsMutable() {
          if (!((bitField0_ & 0x00000008) == 0x00000008)) {
            geometry_ = new java.util.ArrayList<Integer>(geometry_);
            bitField0_ |= 0x00000008;
           }
        }
        /**
    ...
    public interface LayerOrBuilder extends
       ...
       * <code>repeated .vector_tile.Tile.Feature features = 2;</code>
       */
      FeatureOrBuilder getFeaturesOrBuilder(
          int index);
    ...
    private static final long serialVersionUID = 0L;
       ...
       * <code>repeated .vector_tile.Tile.Feature features = 2;</code>
       */
      public FeatureOrBuilder getFeaturesOrBuilder(
          int index) {
        return features_.get(index);
      }
      ...
      public static Layer parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static Layer parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static Layer parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(Layer prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      @Override
      public Builder toBuilder() {
      ...
      public static final class Builder extends
        ...
        public Builder mergeFrom(Layer other) {
          if (other == Layer.getDefaultInstance()) return this;
          if (other.hasVersion()) {
        ...
        public Builder mergeFrom(
          ...
          try {
            ...
            parsedMessage = (Layer) e.getUnfinishedMessage();
            throw e.unwrapIOException();
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000002;
         ...
         * <code>repeated .vector_tile.Tile.Feature features = 2;</code>
         */
        public Feature.Builder getFeaturesBuilder(
            int index) {
  ...
  ensureKeysIsMutable();
     ...
     * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
     */
    public LayerOrBuilder getLayersOrBuilder(
        int index) {
      return layers_.get(index);
    }
    ...
    public static final class Builder extends
       ...
       */
      public Builder setLayers(
          int index, Layer.Builder builderForValue) {
        if (layersBuilder_ == null) {
          ensureLayersIsMutable();
       ...
       * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
       */
      public Builder addLayers(Layer value) {
        if (layersBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
       */
      public Layer.Builder getLayersBuilder(
          int index) {
      ...
      public Layer.Builder addLayersBuilder(
          int index) {
        return getLayersFieldBuilder().addBuilder(
            index, Layer.getDefaultInstance());
      }
      /**
       * <code>repeated .vector_tile.Tile.Layer layers = 3;</code>
       */
