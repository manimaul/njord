...
//    private val geometryFactory = GeometryFactory()
    ...
    fun tileGeometry(geometry: GeosGeometry, x: Int, y: Int, z: Int): GeosGeometry {
        TODO()
//        return TileGeometryTransformer(x, y, z).transform(geometry)
    }

    private fun Coordinate.newCoordinate(x: Number? = null, y: Number? = null): Coordinate =
        Coordinate(x?.toDouble() ?: this.x, y?.toDouble() ?: this.y)
